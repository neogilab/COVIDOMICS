...
```{r}
retrieve_genes(pro_hc_mild_symbols_FDR, tf_gmt, hc_mild_tf, 0.05, 0.2) %>% arrange(desc(num_genes_FDR0.05)) %>% DT::datatable(., filter = "top", rownames = F) %>% DT::formatStyle(columns = seq(1,300), fontSize='85%')
```
